...
//            Log.e(TAG, "init js error:" + e.getMessage());
    ...
    private String genJavaMethodSign(Method method) {
        ...
        if (len < 1 || argsTypes[0] != XWalkView.class) {
//        if (len < 1 || argsTypes[0] != WebView.class) {
    ...
    public String call(XWalkView webView, String jsonStr) {
    ...
    private String getReturn(String reqJson, int stateCode, Object result) {
        ...
        jsonResult = String.format(RETURN_RESULT_FORMAT, stateCode, insertRes);
        //	Log.d(TAG, mInjectedName + " call json: " + reqJson + " result:" + jsonResult);
        return jsonResult;
    }
